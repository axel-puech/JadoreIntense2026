...
//sampler sampler flipbookTexSmpSC 2:20
...
//sampler sampler sc_OITCommonSampler 2:28
//sampler sampler sc_ScreenTextureSmpSC 2:30
//texture texture2D flipbookTex 2:0:2:20
...
//texture texture2D sc_OITAlpha0 2:8:2:28
//texture texture2D sc_OITAlpha1 2:9:2:28
//texture texture2D sc_OITDepthHigh0 2:10:2:28
//texture texture2D sc_OITDepthHigh1 2:11:2:28
//texture texture2D sc_OITDepthLow0 2:12:2:28
//texture texture2D sc_OITDepthLow1 2:13:2:28
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:14:2:28
//texture texture2D sc_OITFrontDepthTexture 2:15:2:28
//texture texture2D sc_ScreenTexture 2:17:2:30
//SG_REFLECTION_END
...
uniform float Port_Speed_N194;
uniform float Port_SecondOffset_N194;
...
int l9_0=InstanceID;
ivec2 l9_1=ivec2(l9_0%200,l9_0/200);
float l9_2=float(l9_0);
vec2 l9_3=vec2(l9_1);
float l9_4=l9_2*0.0251256;
float l9_5;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Dead,l9_4,fract(abs(((l9_2*0.00490643)+0.151235)+(floor(((l9_5-l9_4)+10.0)*0.2)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))*vec2(0.00250627),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.65661e-10,l9_0,(l9_2+0.5)*0.005,l9_2*0.00502513,l9_1,(l9_3+vec2(0.5))*vec2(0.005,1.0),l9_3*vec2(0.00502513,1.0),vec3(0.0),false);
...
int l9_8=int(Port_SpriteCount_N194.x);
int l9_9=int(Port_SpriteCount_N194.y);
int l9_10=l9_8*l9_9;
int l9_11=int(Port_MaxFrames_N194);
int l9_12=(l9_10<l9_11) ? l9_10 : l9_11;
int l9_13=int(float(Interp_Particle_Index));
float l9_14=1.0/float(l9_9);
int l9_15=l9_13-(l9_12*(l9_13/l9_12));
int l9_16=l9_15/l9_8;
int l9_17;
...
#endif
vec4 l9_18=sc_SampleTextureBiasOrLevel(flipbookTexDims.xy,flipbookTexLayout,l9_17,mod(vec2((1.0/float(l9_8))*(l9_7.x+float(l9_15-(l9_8*l9_16))),((1.0-l9_14)-(float(l9_16)*l9_14))+(l9_14*l9_7.y)),vec2(1.0)),(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex),(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0),flipbookTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0),flipbookTexBorderColor,0.0,flipbookTex);
vec4 l9_19=l9_18*Interp_Particle_Color;
float l9_20;
#if (Tweak_N90)
{
vec2 l9_21=((((l9_7-Port_Center_N034)*(vec2(Port_Input0_N033)/(clamp(Port_Import_N091,vec2(0.0),vec2(10.0))+vec2(1.234e-06))))+Port_Center_N034)*vec2(Port_Input1_N035))-vec2(Port_Input1_N037);
float l9_22=atan(l9_21.y*Port_Input1_N041,l9_21.x);
float l9_23=(Port_Input0_N052*3.14159)/(clamp(floor(sideCount),Port_Input1_N055,Port_Input2_N055)+1.234e-06);
l9_20=clamp((((((1.0-(cos((floor((l9_22/(l9_23+1.234e-06))+Port_Input1_N059)*l9_23)-l9_22)*length(l9_21)))-Port_RangeMinA_N067)/(clamp(Port_Import_N031,0.0,1.0)-Port_RangeMinA_N067))*(Port_RangeMaxB_N067-Port_RangeMinB_N067))+Port_RangeMinB_N067)+0.001,Port_Input1_N068+0.001,Port_Input2_N068+0.001)-0.001;
}
#else
{
l9_20=Port_Input2_N071;
}
#endif
float l9_24=fadeDistanceInvisible+Port_Input1_N046;
float l9_25=l9_24*l9_24;
float l9_26=fadedistanceVisible*fadedistanceVisible;
float l9_27;
if (float(l9_25>l9_26)!=0.0)
{
vec3 l9_28=sc_Camera.position-Interp_Particle_Position;
l9_27=1.0-smoothstep(min(l9_25,l9_26),max(l9_25,l9_26),dot(l9_28,l9_28));
}
else
{
vec3 l9_29=sc_Camera.position-Interp_Particle_Position;
l9_27=smoothstep(min(l9_25,l9_26),max(l9_25,l9_26),dot(l9_29,l9_29));
}
vec4 l9_30=vec4(l9_19.x,l9_19.y,l9_19.z,vec4(0.0).w);
l9_30.w=(Interp_Particle_Color.w*l9_20)*l9_27;
vec4 l9_31=ngsPixelShader(l9_30);
vec4 l9_32;
