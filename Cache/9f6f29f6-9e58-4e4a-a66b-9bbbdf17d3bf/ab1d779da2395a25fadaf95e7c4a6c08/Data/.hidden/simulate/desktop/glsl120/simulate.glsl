...
uniform vec3 Port_Import_N007;
uniform vec3 Port_Min_N008;
uniform vec3 Port_Max_N008;
uniform float Port_Min_N018;
uniform float Port_Max_N018;
uniform float Port_Import_N084;
uniform vec3 Port_Import_N088;
uniform vec3 Port_Import_N139;
uniform vec3 Port_Import_N140;
uniform float _sc_allow16TexturesMarker;
uniform float overrideTimeDelta;
uniform vec3 Port_Import_N100;
uniform vec3 Port_Import_N106;
...
uniform float Port_Input0_N119;
uniform float Port_Input1_N131;
uniform float Port_Input2_N131;
...
uniform float Port_Import_N113;
...
Particle.Seed+=(floor(((l9_0-Particle.SpawnOffset)+10.0)*0.2)*4.32723);
...
ivec2 l9_0=ivec2(InstanceID%200,InstanceID/200);
float l9_1=float(InstanceID);
vec2 l9_2=vec2(l9_0);
ssParticle l9_3=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Dead,l9_1*0.0251256,0.0,gParticle.Seed2000,float(((InstanceID*((InstanceID*1471343)+101146501))+1559861749)&2147483647)*4.65661e-10,InstanceID,(l9_1+0.5)*0.005,l9_1*0.00502513,l9_0,(l9_2+vec2(0.5))*vec2(0.005,1.0),l9_2*vec2(0.00502513,1.0),vec3(0.0),false);
...
gParticle.Age=mod(l9_8-gParticle.SpawnOffset,5.0);
...
if (!l9_15)
{
l9_16=mod(l9_4-gParticle.SpawnOffset,5.0)<=l9_5;
}
else
{
l9_16=l9_15;
...
gParticle.Position=(vec3((float(gParticle.Index1D-((gParticle.Index1D/14)*14))*0.142857)-1.0,(float(gParticle.Index1D/14)*0.142857)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Mass=1.0;
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Size=mix(Port_Import_N267,Port_Import_N268,ssGetParticleRandom(1,true,true,true,269.0,gParticle,0.0,l9_4).x);
gParticle.Life=mix(Port_Import_N004,Port_Import_N126,ssGetParticleRandom(1,true,true,true,127.0,gParticle,0.0,l9_4).x);
gParticle.Life=clamp(gParticle.Life,0.1,5.0);
vec4 l9_18=ssGetParticleRandom(3,true,true,true,8.0,gParticle,0.0,l9_4);
vec3 l9_19=mix(Port_Min_N008,Port_Max_N008,l9_18.xyz);
vec4 l9_20=ssGetParticleRandom(1,true,true,true,18.0,gParticle,0.0,l9_4);
float l9_21=mix(Port_Min_N018,Port_Max_N018,l9_20.x);
float l9_22;
if (l9_21<=0.0)
{
l9_22=0.0;
...
gParticle.Position=Port_Import_N007+((((l9_19/(vec3(length(l9_19))+vec3(1.234e-06)))*vec3(l9_23))*vec3(Port_Import_N084))*Port_Import_N088);
gParticle.Color=mix(colorMin,colorMax,ssGetParticleRandom(4,false,true,true,12.0,gParticle,0.0,l9_4));
vec3 l9_24=mix(Port_Import_N139,Port_Import_N140,ssGetParticleRandom(3,true,true,true,141.0,gParticle,0.0,l9_4).xyz);
float l9_25=radians(l9_24.x);
float l9_26=cos(l9_25);
float l9_27=sin(l9_25);
float l9_28=radians(l9_24.y);
float l9_29=cos(l9_28);
float l9_30=sin(l9_28);
float l9_31=radians(l9_24.z);
float l9_32=cos(l9_31);
float l9_33=sin(l9_31);
float l9_34=l9_27*l9_30;
float l9_35=l9_26*l9_30;
gParticle.Matrix=mat3(vec3(l9_29*l9_32,(l9_26*l9_33)+(l9_34*l9_32),(l9_27*l9_33)-(l9_35*l9_32)),vec3((-l9_29)*l9_33,(l9_26*l9_32)-(l9_34*l9_33),(l9_27*l9_32)+(l9_35*l9_33)),vec3(l9_30,(-l9_27)*l9_29,l9_26*l9_29));
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.03333);
gParticle.Force=vec3(0.0);
gParticle.Spawned=true;
}
vec3 l9_36=((gParticle.Position+Port_Import_N106)+(Port_Import_N318*vec3(l9_8*Port_Multiplier_N319)))*(vec3(1.0)/Port_Import_N322);
vec2 l9_37=vec2(l9_36.xy)+Port_Input1_N326;
vec2 l9_38=l9_37;
l9_38.x=floor(l9_37.x*10000.0)*0.0001;
vec2 l9_39=l9_38;
l9_39.y=floor(l9_37.y*10000.0)*0.0001;
vec2 l9_40=vec2(l9_36.yz)+Port_Input1_N329;
vec2 l9_41=l9_40;
l9_41.x=floor(l9_40.x*10000.0)*0.0001;
vec2 l9_42=l9_41;
l9_42.y=floor(l9_40.y*10000.0)*0.0001;
vec2 l9_43=vec2(l9_36.zx)+Port_Input1_N332;
vec2 l9_44=l9_43;
l9_44.x=floor(l9_43.x*10000.0)*0.0001;
vec2 l9_45=l9_44;
l9_45.y=floor(l9_43.y*10000.0)*0.0001;
vec3 l9_46=vec3(0.0);
l9_46.x=floor(((snoise(l9_39*(Port_Scale_N327*0.5))*0.5)+0.5)*10000.0)*0.0001;
vec3 l9_47=l9_46;
l9_47.y=floor(((snoise(l9_42*(Port_Scale_N330*0.5))*0.5)+0.5)*10000.0)*0.0001;
vec3 l9_48=l9_47;
l9_48.z=floor(((snoise(l9_45*(Port_Scale_N333*0.5))*0.5)+0.5)*10000.0)*0.0001;
gParticle.Force+=(Port_Import_N100*((l9_48*Port_Input1_N335)-vec3(1.0)));
float l9_49=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_50=gParticle.Life+1.234e-06;
vec4 l9_51=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_51.w=mix(Port_Import_N026,Port_Import_N027,(clamp((l9_49*(Port_Input0_N214/((Port_Import_N029/l9_50)+1.234e-06)))+0.001,Port_Input1_N110+0.001,Port_Input2_N110+0.001)-0.001)*(clamp(((1.0-l9_49)*(Port_Input0_N119/((Port_Import_N043/l9_50)+1.234e-06)))+0.001,Port_Input1_N131+0.001,Port_Input2_N131+0.001)-0.001));
gParticle.Color=l9_51;
float l9_52=clamp(l9_5,0.0001,0.5);
float l9_53;
...
{
l9_53=gParticle.Force.x;
}
gParticle.Force.x=l9_53;
float l9_54;
...
{
l9_54=gParticle.Force.y;
}
gParticle.Force.y=l9_54;
float l9_55;
...
{
l9_55=gParticle.Force.z;
}
gParticle.Force.z=l9_55;
gParticle.Mass=max(0.005,gParticle.Mass);
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*l9_52);
float l9_56;
...
{
l9_56=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_56;
float l9_57;
...
{
l9_57=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_57;
float l9_58;
...
{
l9_58=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_58;
gParticle.Position+=(gParticle.Velocity*l9_52);
vec2 l9_59=vec2(6.0,1.0)/vec2(2048.0,ssTARGET_SIZE_FLOAT.y);
int l9_60=vfxOffsetInstances+sc_GetLocalInstanceID();
vec2 l9_61=vec2(0.0);
l9_61.x=float(l9_60%341);
vec2 l9_62=l9_61;
l9_62.y=float(l9_60/341);
float l9_63;
if (l9_1.x<0.5)
{
l9_63=0.0;
...
vec2 l9_66=l9_64;
l9_66.y=l9_65;
sc_SetClipPosition(vec4(((l9_66+(l9_62*l9_59))*2.0)-vec2(1.0),1.0,1.0));
...
{
l9_67=vec4((l9_1*2.0)-vec2(1.0),1.0,1.0);
}
else
{
l9_67=vec4(0.0);
}
sc_SetClipPosition(l9_67);
...
if (l9_1==0)
{
vec4 l9_18=ssEncodeFloat32(gParticle.Color.x,0.0,1.0,0.99999);
vec4 l9_19=ssEncodeFloat32(gParticle.Color.y,0.0,1.0,0.99999);
vec4 l9_20=ssEncodeFloat32(gParticle.Color.z,0.0,1.0,0.99999);
vec4 l9_21=ssEncodeFloat32(gParticle.Color.w,0.0,1.0,0.99999);
l9_17=l9_21.w;
l9_16=l9_21.z;
l9_15=l9_21.y;
l9_14=l9_21.x;
...
if (l9_1==1)
{
vec4 l9_38=ssEncodeFloat32(gParticle.Matrix[0].x,-100.0,100.0,0.99999);
vec4 l9_39=ssEncodeFloat32(gParticle.Matrix[0].y,-100.0,100.0,0.99999);
vec4 l9_40=ssEncodeFloat32(gParticle.Matrix[0].z,-100.0,100.0,0.99999);
vec4 l9_41=ssEncodeFloat32(gParticle.Matrix[1].x,-100.0,100.0,0.99999);
l9_37=l9_41.w;
l9_36=l9_41.z;
l9_35=l9_41.y;
l9_34=l9_41.x;
...
if (l9_1==2)
{
vec4 l9_58=ssEncodeFloat32(gParticle.Matrix[1].y,-100.0,100.0,0.99999);
vec4 l9_59=ssEncodeFloat32(gParticle.Matrix[1].z,-100.0,100.0,0.99999);
vec4 l9_60=ssEncodeFloat32(gParticle.Matrix[2].x,-100.0,100.0,0.99999);
vec4 l9_61=ssEncodeFloat32(gParticle.Matrix[2].y,-100.0,100.0,0.99999);
l9_57=l9_61.w;
l9_56=l9_61.z;
l9_55=l9_61.y;
l9_54=l9_61.x;
...
if (l9_1==3)
{
vec4 l9_78=ssEncodeFloat32(gParticle.Matrix[2].z,-100.0,100.0,0.99999);
vec4 l9_79=ssEncodeFloat32(gParticle.Position.x,-1000.0,1000.0,0.99999);
vec4 l9_80=ssEncodeFloat32(gParticle.Position.y,-1000.0,1000.0,0.99999);
vec4 l9_81=ssEncodeFloat32(gParticle.Position.z,-1000.0,1000.0,0.99999);
l9_77=l9_81.w;
l9_76=l9_81.z;
l9_75=l9_81.y;
l9_74=l9_81.x;
...
if (l9_1==4)
{
vec4 l9_98=ssEncodeFloat32(gParticle.Life,0.0,5.0,0.99999);
vec4 l9_99=ssEncodeFloat32(gParticle.Age,0.0,5.0,0.99999);
vec4 l9_100=ssEncodeFloat32(gParticle.Size,0.0,100.0,0.99999);
vec4 l9_101=ssEncodeFloat32(gParticle.Velocity.x,-1000.0,1000.0,0.99999);
l9_97=l9_101.w;
l9_96=l9_101.z;
l9_95=l9_101.y;
l9_94=l9_101.x;
...
if (l9_1==5)
{
vec4 l9_111=ssEncodeFloat32(gParticle.Velocity.y,-1000.0,1000.0,0.99999);
vec4 l9_112=ssEncodeFloat32(gParticle.Velocity.z,-1000.0,1000.0,0.99999);
