...
#endif
vec4 l9_29=Interp_Particle_Color*l9_28;
vec4 l9_30;
...
#else
{
vec2 l9_36=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_37;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_38=vec3(l9_36,0.0);
l9_38.y=((2.0*l9_36.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_37=l9_38.xy;
}
#else
{
...
#endif
l9_32=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,l9_39).xy,0.0);
}
#endif
vec4 l9_40;
...
{
vec4 l9_41=l9_32;
l9_41.x=l9_32.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_40=l9_41;
}
#else
{
...
#endif
vec3 l9_42=mix(l9_40.xyz,definedBlend(l9_40.xyz,l9_29.xyz).xyz,vec3(l9_29.w));
...
{
float l9_45=l9_29.w;
l9_44=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_45)),l9_45);
}
#else
{
vec4 l9_46;
...
#endif
l9_46=vec4(l9_29.xyz*l9_48,l9_48);
}
#else
{
l9_46=l9_29;
...
sc_writeFragData0Internal(l9_50,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
