...
//texture texture2DArray baseTexArrSC 0:33:0:20
...
//spec_const bool baseTexHasSwappedViews 37 0
...
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 46 0
//spec_const bool sc_BlendMode_Screen 47 0
//spec_const bool sc_BlendMode_Software 48 0
//spec_const bool sc_CanUseTextureLod 49 0
//spec_const bool sc_FramebufferFetch 50 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 51 0
//spec_const bool sc_IsEditor 52 0
//spec_const bool sc_MotionVectorsPass 53 0
//spec_const bool sc_RenderAlphaToColor 54 0
//spec_const bool sc_ScreenTextureHasSwappedViews 55 0
//spec_const bool sc_ShaderComplexityAnalyzer 56 0
//spec_const bool sc_UseFramebufferFetchMarker 57 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 58 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 59 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 60 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 61 -1
//spec_const int baseTexLayout 62 0
//spec_const int intensityTextureLayout 63 0
//spec_const int renderTarget0Layout 64 0
//spec_const int renderTarget1Layout 65 0
//spec_const int renderTarget2Layout 66 0
//spec_const int renderTarget3Layout 67 0
//spec_const int sc_DepthBufferMode 68 0
//spec_const int sc_ScreenTextureLayout 69 0
//spec_const int sc_ShaderCacheConstant 70 0
//spec_const int sc_StereoRenderingMode 71 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 72 0
//spec_const int sc_StereoViewID 73 0
//SG_REFLECTION_END
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/2001];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(2001*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/2001]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_10=-normalize(-sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][2].xyz);
vec3 l9_11=normalize(cross(l9_10,normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz)));
vec3 l9_12=normalize(cross(l9_11,l9_10));
vec2 l9_13=mat2(vec2(gParticle.Matrix[0].x,gParticle.Matrix[0].y),vec2(gParticle.Matrix[1].x,gParticle.Matrix[1].y))*(texture0-vec2(0.5));
varPos=gParticle.Position;
varPos+=((-l9_11)*(gParticle.Size*l9_13.x));
varPos+=(l9_12*((gParticle.Size*l9_13.y)*1.0));
varNormal=l9_10;
varTangent=vec4(l9_12.x,l9_12.y,l9_12.z,varTangent.w);
vec4 l9_14=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
vec4 l9_15;
...
float l9_17=l9_14.w;
vec4 l9_18=l9_14;
l9_18.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_17))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_17;
l9_16=l9_18;
}
else
{
...
#endif
vec4 l9_53=Interp_Particle_Color*l9_4;
vec4 l9_54;
...
#else
{
vec2 l9_60=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_61;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_62=vec3(l9_60,0.0);
l9_62.y=((2.0*l9_60.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_61=l9_62.xy;
}
#else
{
...
{
l9_64=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_61,sc_ScreenTextureLayout,l9_63),0.0);
}
#else
{
l9_64=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_61,sc_ScreenTextureLayout,l9_63).xy,0.0);
}
#endif
l9_56=l9_64;
}
...
{
vec4 l9_66=l9_56;
l9_66.x=l9_56.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_65=l9_66;
}
#else
{
...
#endif
vec3 l9_67=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_53.xyz).xyz,vec3(l9_53.w));
...
{
float l9_70=l9_53.w;
l9_69=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_70)),l9_70);
}
#else
{
vec4 l9_71;
...
#endif
l9_71=vec4(l9_53.xyz*l9_73,l9_73);
}
#else
{
l9_71=l9_53;
