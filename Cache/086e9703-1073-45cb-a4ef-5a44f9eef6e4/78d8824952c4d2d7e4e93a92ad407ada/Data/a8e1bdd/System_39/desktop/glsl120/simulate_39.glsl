...
gParticle.CopyId=float(InstanceID/2001);
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/2001];
}
else
{
l9_15=l9_14;
...
float l9_4=0.99998999-0.0;
gParticle.SpawnIndex=(-1.0)+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_3,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(500000.0-(-1.0)))/l9_4);
gParticle.NextBurstTime=0.0+(((DecodeFloat16(renderTarget1SampleViewIndexBias(l9_3,renderTarget1GetStereoViewIndex(),0.0).xy,true)-0.0)*(300.0-0.0))/l9_4);
int l9_5=sc_GetLocalInstanceID()/2001;
float l9_6=min(overrideTimeDelta,0.5);
float l9_7=gParticle.TimeShift;
float l9_8=(sc_Time.x-(l9_7*l9_6))-0.0;
if (vfxEmitParticle[sc_GetLocalInstanceID()/2001])
{
gParticle.SpawnAmount+=(Port_SpawnRate_N013*l9_6);
...
float l9_9=gParticle.Age;
bool l9_10=l9_9<=9.9999997e-05;
bool l9_11;
if (!l9_10)
{
l9_11=gParticle.Age>=(gParticle.Life-l9_6);
}
else
{
l9_11=l9_10;
}
float l9_12=gParticle.Index1DPerCopyF;
float l9_13=gParticle.SpawnIndex;
float l9_14=gParticle.Index1DPerCopyF;
float l9_15=gParticle.SpawnIndex;
float l9_16=gParticle.SpawnAmount;
float l9_17=gParticle.Index1DPerCopyF;
float l9_18=gParticle.SpawnIndexRemainder;
bool l9_19;
if (l9_11)
{
l9_19=((l9_12<=l9_13)&&(l9_14>=(l9_15-l9_16)))||(l9_17<=l9_18);
}
else
{
l9_19=l9_11;
...
if (l9_19)
{
ssGlobals l9_20=ssGlobals(sc_Time.x,l9_6,l9_8,overrideTimeElapsed[l9_5]);
float l9_21=max(Port_Import_N050,0.0099999998);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_23=floor(44.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_23))/44.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_23)/44.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
tempGlobals=l9_20;
vec3 l9_24=N42_system_getParticleRandomVec3(true,true,true,0.0);
vec3 l9_25=N42_system_getParticleRandomVec3(true,true,true,150.0);
float l9_26=1.0-clamp(Port_Import_N041,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
vec3 l9_28=vec3(l9_27);
vec3 l9_29=mix(l9_28,vec3(1.0),l9_24);
float l9_30=l9_29.x;
float l9_31;
if (l9_30<=0.0)
{
...
vec3 l9_36=mix(vec3(-1.0),vec3(1.0),l9_25);
gParticle.Position=(((vec3(l9_31,l9_33,l9_35)*(l9_36/vec3(length(l9_36+vec3(9.9999997e-05)))))*Port_Import_N037)*Port_Import_N036)+Port_Import_N038;
tempGlobals=l9_20;
gParticle.Size=mix(Port_Import_N046*l9_21,Port_Import_N049*l9_21,ssGetParticleRandom(1,true,true,true,51.0,gParticle,20.0,tempGlobals.gTimeElapsed).x)/length(vfxLocalAabbMax-vfxLocalAabbMin);
...
vec3 l9_38=Port_Import_N054-l9_37;
...
gParticle.Force+=(vec3(Port_Import_N053)*(l9_38*l9_40));
...
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/2001]*vec4(gParticle.Position,1.0)).xyz;
int l9_41=sc_GetLocalInstanceID()/2001;
gParticle.Velocity=mat3(vfxModelMatrix[l9_41][0].xyz,vfxModelMatrix[l9_41][1].xyz,vfxModelMatrix[l9_41][2].xyz)*gParticle.Velocity;
int l9_42=sc_GetLocalInstanceID()/2001;
gParticle.Force=mat3(vfxModelMatrix[l9_42][0].xyz,vfxModelMatrix[l9_42][1].xyz,vfxModelMatrix[l9_42][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/2001][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/2001][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/2001][2].xyz)))*gParticle.Size;
...
ssGlobals l9_43=ssGlobals(sc_Time.x,l9_6,l9_8,overrideTimeElapsed[l9_5]);
tempGlobals=l9_43;
float l9_44=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
vec4 l9_45=gParticle.Color;
l9_45.w=mix(Port_Import_N004,Port_Import_N017,clamp(l9_44/(Port_Import_N185/gParticle.Life),0.0,1.0)*clamp((1.0-l9_44)/(Port_Import_N188/gParticle.Life),0.0,1.0));
gParticle.Color=l9_45;
tempGlobals=l9_43;
vec3 l9_46=abs(gParticle.Velocity*gParticle.Mass)/vec3(tempGlobals.gTimeDelta);
gParticle.Force+=clamp((((((-gParticle.Velocity)*length(gParticle.Velocity))*Port_Import_N267)*Port_Import_N268)*Port_Import_N269)*0.5,-l9_46,l9_46);
...
{
l9_47=gParticle.Force.x;
}
gParticle.Force.x=l9_47;
float l9_48;
...
{
l9_48=gParticle.Force.y;
}
gParticle.Force.y=l9_48;
float l9_49;
...
{
l9_49=gParticle.Force.z;
}
gParticle.Force.z=l9_49;
gParticle.Mass=max(0.0049999999,gParticle.Mass);
if (l9_6!=0.0)
{
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*l9_6);
}
float l9_50;
...
{
l9_50=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_50;
float l9_51;
...
{
l9_51=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_51;
float l9_52;
...
{
l9_52=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_52;
gParticle.Position+=(gParticle.Velocity*l9_6);
vec2 l9_53=vec2(3.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_54=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_55;
if (texture0.x<0.5)
{
l9_55=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_55,l9_56)+(vec2(float(l9_54%682),float(l9_54/682))*l9_53))*2.0)-vec2(1.0),1.0,1.0));
...
vec4 l9_69=vec4(l9_5,l9_6,l9_7,l9_8);
vec4 l9_70=vec4(l9_9,l9_10,l9_11,l9_12);
vec4 l9_71=vec4(l9_13,l9_14,l9_15,l9_16);
vec4 l9_72=vec4(l9_17,l9_18,l9_19,l9_20);
vec4 l9_73;
vec4 l9_74;
if (int(Interp_Particle_Index)==((2001*(int(Interp_Particle_Index/2001.0)+1))-1))
{
vec2 l9_75=ssEncodeFloat16(Interp_Particle_NextBurstTime,0.0,300.0,0.99998999);
l9_74=vec4(l9_75.x,l9_75.y,l9_70.z,l9_70.w);
l9_73=ssEncodeFloat32(Interp_Particle_SpawnIndex,-1.0,500000.0,0.99998999);
}
else
{
l9_74=l9_70;
...
vec4 l9_76;
if (dot(((l9_73+l9_74)+l9_71)+l9_72,vec4(0.23454))==0.34231836)
{
l9_76=l9_73+vec4(1e-06);
}
else
{
l9_76=l9_73;
...
sc_writeFragData1(l9_74);
sc_writeFragData2(l9_71);
sc_writeFragData3(l9_72);
}
