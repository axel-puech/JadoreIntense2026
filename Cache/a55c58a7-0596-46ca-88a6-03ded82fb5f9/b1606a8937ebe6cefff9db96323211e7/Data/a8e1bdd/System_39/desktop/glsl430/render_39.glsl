...
//sampler sampler flipbookTexSmpSC 0:20
...
//texture texture2D flipbookTex 0:0:0:20
...
//texture texture2DArray flipbookTexArrSC 0:33:0:20
//texture texture2DArray intensityTextureArrSC 0:34:0:21
//texture texture2DArray renderTarget0ArrSC 0:35:0:22
//texture texture2DArray renderTarget1ArrSC 0:36:0:23
//texture texture2DArray renderTarget2ArrSC 0:37:0:24
//texture texture2DArray renderTarget3ArrSC 0:38:0:25
//texture texture2DArray sc_ScreenTextureArrSC 0:41:0:30
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_flipbookTex 31 0
...
//spec_const bool SC_USE_UV_TRANSFORM_flipbookTex 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N90 37 0
//spec_const bool flipbookTexHasSwappedViews 38 0
//spec_const bool intensityTextureHasSwappedViews 39 0
//spec_const bool renderTarget0HasSwappedViews 40 0
//spec_const bool renderTarget1HasSwappedViews 41 0
//spec_const bool renderTarget2HasSwappedViews 42 0
//spec_const bool renderTarget3HasSwappedViews 43 0
...
//spec_const bool sc_BlendMode_Screen 48 0
//spec_const bool sc_BlendMode_Software 49 0
//spec_const bool sc_CanUseTextureLod 50 0
//spec_const bool sc_FramebufferFetch 51 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 52 0
//spec_const bool sc_IsEditor 53 0
//spec_const bool sc_MotionVectorsPass 54 0
//spec_const bool sc_RenderAlphaToColor 55 0
//spec_const bool sc_ScreenTextureHasSwappedViews 56 0
//spec_const bool sc_ShaderComplexityAnalyzer 57 0
//spec_const bool sc_UseFramebufferFetchMarker 58 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_flipbookTex 59 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 60 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_flipbookTex 61 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 62 -1
//spec_const int flipbookTexLayout 63 0
...
//spec_const int sc_StereoViewID 74 0
//SG_REFLECTION_END
...
uniform float Port_Input0_N033;
uniform vec2 Port_Center_N034;
...
uniform float Port_Input2_N055;
...
uniform sc_Camera_t sc_Camera;
uniform vec2 Port_SpriteCount_N194;
uniform float Port_MaxFrames_N194;
uniform float Port_Input2_N071;
...
#endif
float l9_4=floor(Port_SpriteCount_N194.x);
float l9_5=floor(Port_SpriteCount_N194.y);
float l9_6=1.0/l9_4;
float l9_7=1.0/l9_5;
float l9_8=floor(mod(floor(float(Interp_Particle_Index%200)),min(l9_4*l9_5,floor(Port_MaxFrames_N194))));
float l9_9=(l9_6*varPackedTex.x)+(mod(l9_8,l9_4)*l9_6);
float l9_10=((1.0-l9_7)-(floor(l9_8/l9_4)*l9_7))+(l9_7*varPackedTex.y);
vec4 l9_11;
#if (flipbookTexLayout==2)
{
bool l9_12=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_13=l9_9;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_14=l9_13;
float l9_15=l9_10;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_16=l9_15;
vec2 l9_17;
float l9_18;
...
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
l9_19=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_20=l9_14;
float l9_21=1.0;
sc_ClampUV(l9_20,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_19,l9_21);
float l9_22=l9_20;
float l9_23=l9_21;
bool l9_24;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
...
float l9_25=l9_16;
float l9_26=l9_23;
sc_ClampUV(l9_25,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_24,l9_26);
l9_18=l9_26;
...
#endif
vec2 l9_27=sc_TransformUV(l9_17,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_28=l9_27.x;
float l9_29=l9_18;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_12,l9_29);
float l9_30=l9_27.y;
float l9_31=l9_29;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_12,l9_31);
float l9_32=l9_31;
vec3 l9_33=sc_SamplingCoordsViewToGlobal(vec2(l9_28,l9_30),flipbookTexLayout,flipbookTexGetStereoViewIndex());
vec4 l9_34=texture(flipbookTexArrSC,l9_33,0.0);
vec4 l9_35;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_35=mix(flipbookTexBorderColor,l9_34,vec4(l9_32));
}
#else
{
l9_35=l9_34;
...
#else
{
bool l9_36=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_37=l9_9;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_38=l9_37;
float l9_39=l9_10;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_40=l9_39;
vec2 l9_41;
float l9_42;
#if (SC_USE_UV_MIN_MAX_flipbookTex)
...
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_44=l9_38;
float l9_45=1.0;
sc_ClampUV(l9_44,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_43,l9_45);
float l9_46=l9_44;
float l9_47=l9_45;
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
...
float l9_49=l9_40;
float l9_50=l9_47;
sc_ClampUV(l9_49,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_48,l9_50);
l9_42=l9_50;
...
#endif
vec2 l9_51=sc_TransformUV(l9_41,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_36,l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_36,l9_55);
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),flipbookTexLayout,flipbookTexGetStereoViewIndex());
vec4 l9_58=texture(flipbookTex,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_59=mix(flipbookTexBorderColor,l9_58,vec4(l9_56));
}
#else
{
l9_59=l9_58;
...
#endif
vec4 l9_60=l9_11*Interp_Particle_Color;
float l9_61;
#if (Tweak_N90)
{
vec2 l9_62=((((varPackedTex.xy-Port_Center_N034)*(vec2(Port_Input0_N033)/(clamp(Port_Import_N091,vec2(0.0),vec2(10.0))+vec2(1.234e-06))))+Port_Center_N034)*vec2(Port_Input1_N035))-vec2(Port_Input1_N037);
float l9_63=atan(l9_62.y*Port_Input1_N041,l9_62.x);
float l9_64=(Port_Input0_N052*3.1415927)/(clamp(floor(sideCount),Port_Input1_N055,Port_Input2_N055)+1.234e-06);
l9_61=clamp((((((1.0-(cos((floor((l9_63/(l9_64+1.234e-06))+Port_Input1_N059)*l9_64)-l9_63)*length(l9_62)))-Port_RangeMinA_N067)/((clamp(Port_Import_N031,0.0,1.0)-Port_RangeMinA_N067)+1e-06))*(Port_RangeMaxB_N067-Port_RangeMinB_N067))+Port_RangeMinB_N067)+0.001,Port_Input1_N068+0.001,Port_Input2_N068+0.001)-0.001;
}
#else
{
l9_61=Port_Input2_N071;
}
#endif
float l9_65=fadeDistanceInvisible+Port_Input1_N046;
float l9_66=l9_65*l9_65;
float l9_67=fadedistanceVisible*fadedistanceVisible;
float l9_68;
if ((float(l9_66>l9_67)*1.0)!=0.0)
{
vec3 l9_69=sc_Camera.position-Interp_Particle_Position;
l9_68=1.0-smoothstep(min(l9_66,l9_67),max(l9_66,l9_67),dot(l9_69,l9_69));
}
else
{
vec3 l9_70=sc_Camera.position-Interp_Particle_Position;
l9_68=smoothstep(min(l9_66,l9_67),max(l9_66,l9_67),dot(l9_70,l9_70));
}
float l9_71=Interp_Particle_Color.w*l9_61;
float l9_72=l9_71*l9_68;
vec4 l9_73=vec4(l9_60.x,l9_60.y,l9_60.z,vec4(0.0).w);
l9_73.w=l9_72;
vec4 l9_74;
...
#else
{
vec2 l9_80=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_81;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_82=vec3(l9_80,0.0);
l9_82.y=((2.0*l9_80.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_81=l9_82.xy;
}
#else
{
...
{
l9_84=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_81,sc_ScreenTextureLayout,l9_83),0.0);
}
#else
{
l9_84=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_81,sc_ScreenTextureLayout,l9_83).xy,0.0);
}
#endif
l9_76=l9_84;
}
...
{
vec4 l9_86=l9_76;
l9_86.x=l9_76.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_85=l9_86;
}
#else
{
...
#endif
vec3 l9_87=mix(l9_85.xyz,definedBlend(l9_85.xyz,l9_73.xyz).xyz,vec3(l9_72));
...
{
l9_89=vec4(mix(vec3(1.0),l9_73.xyz,vec3(l9_72)),l9_72);
}
#else
{
vec4 l9_90;
...
#endif
l9_90=vec4(l9_73.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_73;
