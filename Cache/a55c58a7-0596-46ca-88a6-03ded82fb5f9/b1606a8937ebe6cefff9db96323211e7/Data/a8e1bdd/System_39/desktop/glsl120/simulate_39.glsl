...
Particle.Seed+=(floor(((((l9_0-Particle.SpawnOffset)-0.0)+0.0)+10.0)/5.0)*4.32723);
...
gParticle.Age=mod((l9_3-gParticle.SpawnOffset)+0.0,5.0);
float l9_4=gParticle.SpawnOffset;
bool l9_5=(sc_Time.x-l9_4)<(0.0-0.0);
bool l9_6;
if (!l9_5)
{
l9_6=gParticle.Age>5.0;
}
else
{
l9_6=l9_5;
...
if (!l9_9)
{
l9_10=mod(((max(sc_Time.x,0.1)-gParticle.SpawnOffset)-0.0)+0.0,5.0)<=l9_1;
}
else
{
l9_10=l9_9;
...
float l9_12=floor(14.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_12))/14.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_12)/14.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
gParticle.Size=mix(Port_Import_N267,Port_Import_N268,ssGetParticleRandom(1,true,true,true,269.0,gParticle,0.0,sc_Time.x).x);
gParticle.Life=mix(Port_Import_N004,Port_Import_N126,ssGetParticleRandom(1,true,true,true,127.0,gParticle,0.0,sc_Time.x).x);
gParticle.Life=clamp(gParticle.Life,0.1,5.0);
vec4 l9_13=ssGetParticleRandom(3,true,true,true,8.0,gParticle,0.0,sc_Time.x);
vec3 l9_14=mix(Port_Min_N008,Port_Max_N008,l9_13.xyz);
vec4 l9_15=ssGetParticleRandom(1,true,true,true,18.0,gParticle,0.0,sc_Time.x);
float l9_16=mix(Port_Min_N018,Port_Max_N018,l9_15.x);
float l9_17;
if (l9_16<=0.0)
{
l9_17=0.0;
...
gParticle.Position=Port_Import_N007+((((l9_14/(vec3(length(l9_14))+vec3(1.234e-06)))*vec3(l9_18))*vec3(Port_Import_N084))*Port_Import_N088);
gParticle.Color=mix(colorMin,colorMax,ssGetParticleRandom(4,false,true,true,12.0,gParticle,0.0,sc_Time.x));
vec3 l9_19=mix(Port_Import_N139,Port_Import_N140,ssGetParticleRandom(3,true,true,true,141.0,gParticle,0.0,sc_Time.x).xyz);
float l9_20=radians(l9_19.x);
float l9_21=cos(l9_20);
float l9_22=sin(l9_20);
float l9_23=radians(l9_19.y);
float l9_24=cos(l9_23);
float l9_25=sin(l9_23);
float l9_26=radians(l9_19.z);
float l9_27=cos(l9_26);
float l9_28=sin(l9_26);
float l9_29=l9_22*l9_25;
float l9_30=l9_21*l9_25;
gParticle.Matrix=mat3(vec3(l9_24*l9_27,(l9_21*l9_28)+(l9_29*l9_27),(l9_22*l9_28)-(l9_30*l9_27)),vec3((-l9_24)*l9_28,(l9_21*l9_27)-(l9_29*l9_28),(l9_22*l9_27)+(l9_30*l9_28)),vec3(l9_25,(-l9_22)*l9_24,l9_21*l9_24));
...
vec3 l9_31=((gParticle.Position+Port_Import_N106)+(Port_Import_N318*vec3(l9_3*Port_Multiplier_N319)))*(vec3(1.0)/Port_Import_N322);
vec2 l9_32=vec2(l9_31.xy)+Port_Input1_N326;
vec2 l9_33=vec2(l9_31.yz)+Port_Input1_N329;
vec2 l9_34=vec2(l9_31.zx)+Port_Input1_N332;
gParticle.Force+=(Port_Import_N100*((vec3(floor(((snoise(vec2(floor(l9_32.x*10000.0)*9.9999997e-05,floor(l9_32.y*10000.0)*9.9999997e-05)*(Port_Scale_N327*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_33.x*10000.0)*9.9999997e-05,floor(l9_33.y*10000.0)*9.9999997e-05)*(Port_Scale_N330*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_34.x*10000.0)*9.9999997e-05,floor(l9_34.y*10000.0)*9.9999997e-05)*(Port_Scale_N333*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N335)-vec3(1.0)));
float l9_35=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_36=gParticle.Life+1.234e-06;
vec4 l9_37=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_37.w=mix(Port_Import_N026,Port_Import_N027,(clamp((l9_35*(Port_Input0_N214/((Port_Import_N029/l9_36)+1.234e-06)))+0.001,Port_Input1_N110+0.001,Port_Input2_N110+0.001)-0.001)*(clamp(((1.0-l9_35)*(Port_Input0_N119/((Port_Import_N043/l9_36)+1.234e-06)))+0.001,Port_Input1_N131+0.001,Port_Input2_N131+0.001)-0.001));
...
{
l9_38=gParticle.Force.x;
}
gParticle.Force.x=l9_38;
float l9_39;
...
{
l9_39=gParticle.Force.y;
}
gParticle.Force.y=l9_39;
float l9_40;
...
{
l9_40=gParticle.Force.z;
}
gParticle.Force.z=l9_40;
...
{
l9_41=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_41;
float l9_42;
...
{
l9_42=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_42;
float l9_43;
...
{
l9_43=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_43;
gParticle.Position+=(gParticle.Velocity*l9_1);
vec2 l9_44=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_45=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_46;
if (texture0.x<0.5)
{
l9_46=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_46,l9_47)+(vec2(float(l9_45%512),float(l9_45/512))*l9_44))*2.0)-vec2(1.0),1.0,1.0));
...
vec4 l9_43=ssEncodeFloat32(Interp_Particle_Life,0.0,5.0,0.99998999);
vec4 l9_44=ssEncodeFloat32(Interp_Particle_Age,0.0,5.0,0.99998999);
l9_40=l9_44.w;
l9_39=l9_44.z;
l9_38=l9_44.y;
l9_37=l9_44.x;
