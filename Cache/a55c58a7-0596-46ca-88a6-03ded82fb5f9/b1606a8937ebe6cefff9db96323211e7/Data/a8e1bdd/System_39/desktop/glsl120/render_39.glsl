...
float l9_6=1.0/l9_4;
float l9_7=1.0/l9_5;
float l9_8=floor(mod(floor(float(int(Interp_Particle_Index)%200)),min(l9_4*l9_5,floor(Port_MaxFrames_N194))));
int l9_9;
...
#endif
bool l9_10=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_11=(l9_6*varPackedTex.x)+(mod(l9_8,l9_4)*l9_6);
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_12=l9_11;
float l9_13=((1.0-l9_7)-(floor(l9_8/l9_4)*l9_7))+(l9_7*varPackedTex.y);
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_14=l9_13;
vec2 l9_15;
float l9_16;
...
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
...
float l9_18=l9_12;
float l9_19=1.0;
sc_ClampUV(l9_18,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_17,l9_19);
float l9_20=l9_18;
float l9_21=l9_19;
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_23=l9_14;
float l9_24=l9_21;
sc_ClampUV(l9_23,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_22,l9_24);
l9_16=l9_24;
...
#endif
vec2 l9_25=sc_TransformUV(l9_15,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_10,l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_10,l9_29);
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),flipbookTexLayout,l9_9);
vec4 l9_32=texture2D(flipbookTex,l9_31.xy,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_33=mix(flipbookTexBorderColor,l9_32,vec4(l9_30));
}
#else
{
l9_33=l9_32;
...
#endif
vec4 l9_34=l9_33*Interp_Particle_Color;
float l9_35;
#if (Tweak_N90)
{
vec2 l9_36=((((varPackedTex.xy-Port_Center_N034)*(vec2(Port_Input0_N033)/(clamp(Port_Import_N091,vec2(0.0),vec2(10.0))+vec2(1.234e-06))))+Port_Center_N034)*vec2(Port_Input1_N035))-vec2(Port_Input1_N037);
float l9_37=atan(l9_36.y*Port_Input1_N041,l9_36.x);
float l9_38=(Port_Input0_N052*3.1415927)/(clamp(floor(sideCount),Port_Input1_N055,Port_Input2_N055)+1.234e-06);
l9_35=clamp((((((1.0-(cos((floor((l9_37/(l9_38+1.234e-06))+Port_Input1_N059)*l9_38)-l9_37)*length(l9_36)))-Port_RangeMinA_N067)/((clamp(Port_Import_N031,0.0,1.0)-Port_RangeMinA_N067)+1e-06))*(Port_RangeMaxB_N067-Port_RangeMinB_N067))+Port_RangeMinB_N067)+0.001,Port_Input1_N068+0.001,Port_Input2_N068+0.001)-0.001;
}
#else
{
l9_35=Port_Input2_N071;
}
#endif
float l9_39=fadeDistanceInvisible+Port_Input1_N046;
float l9_40=l9_39*l9_39;
float l9_41=fadedistanceVisible*fadedistanceVisible;
float l9_42;
if ((float(l9_40>l9_41)*1.0)!=0.0)
{
vec3 l9_43=sc_Camera.position-Interp_Particle_Position;
l9_42=1.0-smoothstep(min(l9_40,l9_41),max(l9_40,l9_41),dot(l9_43,l9_43));
}
else
{
vec3 l9_44=sc_Camera.position-Interp_Particle_Position;
l9_42=smoothstep(min(l9_40,l9_41),max(l9_40,l9_41),dot(l9_44,l9_44));
}
float l9_45=Interp_Particle_Color.w*l9_35;
float l9_46=l9_45*l9_42;
vec4 l9_47=vec4(l9_34.x,l9_34.y,l9_34.z,vec4(0.0).w);
l9_47.w=l9_46;
vec4 l9_48;
...
#else
{
vec2 l9_54=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_55;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_56=vec3(l9_54,0.0);
l9_56.y=((2.0*l9_54.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_55=l9_56.xy;
}
#else
{
...
#endif
l9_50=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_55,sc_ScreenTextureLayout,l9_57).xy,0.0);
}
#endif
vec4 l9_58;
...
{
vec4 l9_59=l9_50;
l9_59.x=l9_50.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_58=l9_59;
}
#else
{
...
#endif
vec3 l9_60=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_47.xyz).xyz,vec3(l9_46));
...
{
l9_62=vec4(mix(vec3(1.0),l9_47.xyz,vec3(l9_46)),l9_46);
}
#else
{
vec4 l9_63;
...
#endif
l9_63=vec4(l9_47.xyz*l9_64,l9_64);
}
#else
{
l9_63=l9_47;
