...
var MAT_RENDER;
var VFX_OBJECT;
var INSTANCE_COUNT = 200;
var TEXEL_COUNT = 4;
var DIMENSIONS = new vec2(800.0, 1.0);
var COPY_ID = 0;
var MAX_COPIES = 32
...
// VFX Manager
//////////////////////////////////////////////////////////////
function VfxObject(simMaterial, renderMaterial, texelCount, instanceCount, delayAmount) {
	// Time Overrides
...
// Register
//////////////////////////////////////////////////////////////
VfxManager.prototype.register = function(simMaterial, renderMaterial, texelCount, instanceCount, vfxComponent, scriptObject, delayAmount, useFixedDeltaTime, fixedDeltaTime, playRate, paused) {
	...
	if (isNull(newVfx)) {
		newVfx = new VfxObject(simMaterial, renderMaterial, texelCount, instanceCount, delayAmount);
		copyId = newVfx.getNewCopyId();
		newVfx.copiesAdded.push(copyId);
...
VfxManager.prototype.updateEnable = function(pass) {
	...
	for (const vfxObj of pass.vfxObjects){
		...
		for (var i = 0; i < vfxObj.sceneObjects.length; i++) {
			...
			vfxObj.renderMaterialPass["vfxBatchEnable[" + i.toString() + "]"] = vfxObj.sceneObjects[i].isEnabledInHierarchy && isInFrustum && !waitForDelay;
		}
	}
}
...
var updateUniforms = function()
{
	...
	*/
	...
	// Emit
	simulatePass[emitParticleString] = (script.emitParticle && !script.pauseParticle);
...
var initialize = function()
{
	...
	const vfxInfo = global._ngsVfxManager.register(MAT_SIMULATE, MAT_RENDER, TEXEL_COUNT, INSTANCE_COUNT, vfxComponent, scriptObject, DELAY_AMOUNT, TIME_ENABLED, TIME_FIXED_DELTA, TIME_RATE, TIME_PAUSED);
