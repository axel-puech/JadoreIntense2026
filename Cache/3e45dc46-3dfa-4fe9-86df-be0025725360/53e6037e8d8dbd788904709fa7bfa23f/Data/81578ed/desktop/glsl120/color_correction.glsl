...
#endif
float l9_57;
Node11_Conditional(1.0,1.0,Port_Input2_N011,l9_57,l9_2);
l9_3=vec4(mix(l9_56.xyz,Port_Input0_N010*baseColor.xyz,vec3(baseColor.w*l9_57)),1.0);
}
#endif
...
{
l9_60=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_63=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_64;
...
{
l9_64=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_66;
#if (sc_BlendMode_Add)
{
l9_66=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_67;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_67=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_68;
...
{
l9_68=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_69;
#if (sc_BlendMode_Min)
{
l9_69=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
#if (sc_BlendMode_Max)
{
l9_70=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_70=1.0;
...
#endif
l9_58=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_59);
}
#else
{
vec4 l9_71;
...
#endif
l9_73=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_77,sc_ScreenTextureLayout,l9_78).xy,0.0);
}
#endif
vec4 l9_79;
...
#endif
vec3 l9_81=mix(l9_79.xyz,definedBlend(l9_79.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_83=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_84;
...
#endif
l9_84=vec4(l9_3.xyz*l9_85,l9_85);
}
#else
{
l9_84=l9_3;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_92-0.0039215689)),min(1.0,l9_92+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_94),packValue(l9_94),packValue(l9_94),packValue(l9_94)),sc_UniformConstants.x,sc_ShaderCacheConstant);
