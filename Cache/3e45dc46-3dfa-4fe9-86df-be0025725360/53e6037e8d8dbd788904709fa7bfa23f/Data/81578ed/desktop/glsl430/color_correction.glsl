...
//spec_const bool SC_USE_CLAMP_TO_BORDER_screenTexture 36 0
...
//spec_const bool SC_USE_UV_MIN_MAX_screenTexture 40 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 41 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 42 0
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 43 0
//spec_const bool SC_USE_UV_TRANSFORM_screenTexture 44 0
//spec_const bool USE_LEGACY_512_TEXTURE 45 0
...
//spec_const bool opacityTexHasSwappedViews 49 0
...
//spec_const bool screenTextureHasSwappedViews 88 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTexture 92 -1
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTexture 96 -1
//spec_const int baseTexLayout 97 0
//spec_const int intensityTextureLayout 98 0
//spec_const int opacityTexLayout 99 0
...
//spec_const int screenTextureLayout 108 0
//SG_REFLECTION_END
...
#endif
float l9_107;
Node11_Conditional(1.0,1.0,Port_Input2_N011,l9_107,l9_2);
l9_3=vec4(mix(l9_58.xyz,Port_Input0_N010*baseColor.xyz,vec3(baseColor.w*l9_107)),1.0);
}
#endif
...
{
l9_110=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_112;
...
{
l9_113=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_114;
...
{
l9_114=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_115;
...
{
l9_115=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_116;
#if (sc_BlendMode_Add)
{
l9_116=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_117;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_117=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_118;
...
{
l9_118=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_119;
#if (sc_BlendMode_Min)
{
l9_119=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_120;
#if (sc_BlendMode_Max)
{
l9_120=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_120=1.0;
...
#endif
l9_108=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_109);
}
#else
{
vec4 l9_121;
...
#if (sc_FramebufferFetch)
{
vec4 l9_124=sc_readFragData0_Platform();
vec4 l9_125;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_126=l9_124;
l9_126.x=l9_124.x+_sc_framebufferFetchMarker;
l9_125=l9_126;
}
#else
{
...
#else
{
vec2 l9_127=sc_ScreenCoordsGlobalToView(l9_0);
int l9_128;
...
{
l9_129=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_127,sc_ScreenTextureLayout,l9_128),0.0);
}
#else
{
l9_129=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_127,sc_ScreenTextureLayout,l9_128).xy,0.0);
}
#endif
l9_123=l9_129;
}
...
{
vec4 l9_131=l9_123;
l9_131.x=l9_123.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_130=l9_131;
}
#else
{
...
#endif
vec3 l9_132=mix(l9_130.xyz,definedBlend(l9_130.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_134=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_135;
...
#endif
l9_135=vec4(l9_3.xyz*l9_136,l9_136);
}
#else
{
l9_135=l9_3;
...
{
l9_139=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_139=vec4(0.0);
...
vec4 l9_141=outputMotionVectorsIfNeeded(varPos,max(l9_140,vec4(0.0)));
vec4 l9_142=clamp(l9_141,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_143=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_143-0.0039215689)),min(1.0,l9_143+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_144=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_144).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_145=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_144).xy);
float l9_146=packValue(l9_145);
int l9_153=int(l9_142.w*255.0);
float l9_154=packValue(l9_153);
sc_writeFragData0Internal(vec4(packValue(l9_145),packValue(l9_145),packValue(l9_145),packValue(l9_145)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_146,packValue(l9_145),packValue(l9_145),packValue(l9_145)));
sc_writeFragData2(vec4(l9_154,packValue(l9_153),packValue(l9_153),packValue(l9_153)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_157=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_157).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_162==0)
{
l9_165=texture(sc_OITAlpha0,l9_157);
l9_164=texture(sc_OITDepthLow0,l9_157);
l9_163=texture(sc_OITDepthHigh0,l9_157);
}
else
{
l9_165=vec4(0.0);
...
if (l9_162==1)
{
l9_168=texture(sc_OITAlpha1,l9_157);
l9_167=texture(sc_OITDepthLow1,l9_157);
l9_166=texture(sc_OITDepthHigh1,l9_157);
}
else
{
l9_168=l9_165;
...
if (any(notEqual(l9_166,vec4(0.0)))||any(notEqual(l9_167,vec4(0.0))))
{
int l9_169[8]=l9_158;
unpackValues(l9_166.w,l9_162,l9_169);
unpackValues(l9_166.z,l9_162,l9_169);
unpackValues(l9_166.y,l9_162,l9_169);
unpackValues(l9_166.x,l9_162,l9_169);
unpackValues(l9_167.w,l9_162,l9_169);
unpackValues(l9_167.z,l9_162,l9_169);
unpackValues(l9_167.y,l9_162,l9_169);
unpackValues(l9_167.x,l9_162,l9_169);
int l9_178[8]=l9_159;
unpackValues(l9_168.w,l9_162,l9_178);
unpackValues(l9_168.z,l9_162,l9_178);
unpackValues(l9_168.y,l9_162,l9_178);
unpackValues(l9_168.x,l9_162,l9_178);
}
l9_162++;
continue;
}
...
vec4 l9_183=texture(sc_OITFilteredDepthBoundsTexture,l9_157);
vec2 l9_184=l9_183.xy;
int l9_185;
#if (sc_SkinBonesCount>0)
{
l9_185=encodeDepth(((1.0-l9_183.x)*1000.0)+getDepthOrderingEpsilon(),l9_184);
}
#else
{
l9_185=0;
...
#endif
int l9_186=encodeDepth(viewSpaceDepth(),l9_184);
vec4 l9_187;
l9_187=l9_142*l9_142.w;
vec4 l9_188;
int l9_189=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_189<8)
{
int l9_190=l9_158[l9_189];
int l9_191=l9_186-l9_185;
bool l9_192=l9_190<l9_191;
bool l9_193;
if (l9_192)
{
l9_193=l9_158[l9_189]>0;
}
else
{
l9_193=l9_192;
...
if (l9_193)
{
vec3 l9_194=l9_187.xyz*(1.0-(float(l9_159[l9_189])/255.0));
l9_188=vec4(l9_194.x,l9_194.y,l9_194.z,l9_187.w);
}
else
{
l9_188=l9_187;
...
sc_writeFragData0Internal(l9_187,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_141,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
